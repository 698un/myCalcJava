...
//+37529 5827678 Вера
class MyStringGridUpdate extends MyStringGrid {
    ...
    constructor() {
        ...
        this.fldName =["designation","name","department","author"];
        }
    ...
    itemsFromJSON(){
        ...
        //alert("обновляем список:"+arguments[0]);

        let objArray =JSON.parse(arguments[0]);
        ...
        for (let i=0;i<objArray.length;i++){
            ...
            itemOne.id = objArray[i]['id'];

            //Fill all fields of items with index i
            for (let j=0;j<this.fldName.length;j++) {
                itemOne[this.fldName[j]] = objArray[i][this.fldName[j]];
                }//next field
